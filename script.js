...
//style section 4 for scrolling effect
...
// add scroll event listener  - it attaches an event handler to a document

//window-A global variable, window, representing the window in which the script is running, is exposed to JavaScript code.  
window.addEventListener('scroll', () => {
    ...
    // offsetTop - returns the horizontal offset position of element
